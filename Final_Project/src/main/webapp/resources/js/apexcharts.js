        ...
        return a(t, [{
            ...
            key: "renderPaths", value: function (t) {
                ...
                return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(r({}, X, {
                    speed: u,
                    delay: d
                })), A.globals.dataChanged && P && z && C.animatePathsGradually(r({}, X, {speed: p})), M
            }
        }, {
    ...
    var x = {
                ...
                return {
                    ...
                    tooltip: {
                        shared: !1, followCursor: !0, custom: function (t) {
                            var e = t.ctx, i = t.seriesIndex, a = t.dataPointIndex, s = t.y1, n = t.y2, r = t.w,
                                o = r.globals.seriesRangeStart[i][a], l = r.globals.seriesRangeEnd[i][a],
                                h = r.globals.labels[a];
                            s && n && (o = s, l = n, r.config.series[i].data[a].x && (h = r.config.series[i].data[a].x));
                            var c = "", d = "", u = r.globals.colors[i];
                            if (void 0 === r.config.tooltip.x.formatter) if ("datetime" === r.config.xaxis.type) {
                                var g = new v(e);
                                c = g.formatDate(new Date(o), r.config.tooltip.x.format, !0, !0), d = g.formatDate(new Date(l), r.config.tooltip.x.format, !0, !0)
                            } else c = o, d = l; else c = r.config.tooltip.x.formatter(o), d = r.config.tooltip.x.formatter(l);
        ...
        return a(t, [{
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, n = t.i, r = t.pathFrom, o = t.pathTo,
                    l = t.strokeWidth, h = t.elSeries, c = t.x, d = t.y, u = t.y1, f = t.y2, x = t.series,
            ...
            key: "calculateBarsDataLabelsPosition", value: function (t) {
                var e = this.w, i = t.x, a = t.i, s = t.j, n = t.bcy, r = t.barHeight, o = t.barWidth, l = t.textRects,
                    ...
                    p = n - (this.isTimelineBar ? 0 : f) + r / 2 + l.height / 2 + g - 3, x = this.series[a][s] <= 0;
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (k = (h - o) / this.fullAngle * i.config.chart.animations.speed, this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        ...
                        if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var z = i.globals.dataLabels.style.colors[d], T = s.drawText({
                                x: A,
                                y: S,
                                text: L,
                                textAnchor: "middle",
        ...
        return o(i, T), a(i, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0, o = 0; r < t.length; r++, o++) {
                    ...
                    for (var S = a.group({class: "apexcharts-datalabels"}), L = 0, P = i.globals.dataPoints; L < i.globals.dataPoints; L++, P--) {
                        ...
                        var z = 1, T = this.seriesRangeStart[r][L], E = this.seriesRangeEnd[r][L],
                        ...
                        for (var I = 0; I < z; I++) {
                            ...
                            if (this.isHorizontal) {
                                if (Y = b + w * this.visibleI, M) {
                                    var F = (h - w * this.seriesLen) / 2, R = M.y[I];
                                    T = R.y1, E = R.y2;
                            ...
                            var N = s.fillPath({seriesNumber: m, color: O}), H = i.globals.stroke.colors[m];
                            this.renderSeries({
                                realIndex: m,
                                pathFill: N,
                                lineFill: H,
            ...
            key: "drawRangeBarPaths", value: function (t) {
                var e, i, a = t.indexes, s = (t.x, t.y), n = t.y1, r = t.y2, o = t.yDivision, l = t.pathTo,
                    h = t.pathFrom, c = t.barHeight, d = t.barYPosition, u = t.zeroW, g = this.w, f = new p(this.ctx),
                    x = (a.i, a.j), b = a.realIndex;
        ...
        return a(t, [{
            key: "draw", value: function (t, e, i) {
                ...
                for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                    ...
                    var M = a.globals.padHorizontal + m, I = 1;
        ...
        return a(t, [{
            ...
            key: "getMinYMaxY", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Number.MAX_VALUE,
                    ...
                    n = this.w.globals, r = -Number.MAX_VALUE, o = Number.MIN_VALUE;
                null === a && (a = t + 1);
                var l = n.series, h = l, c = l;
        ...
        return a(t, [{
            ...
            key: "plotChartType", value: function (t, e) {
                ...
                var d = new G(this.ctx, e), u = new M(this.ctx, e), g = new Y(this.ctx), f = new R(this.ctx),
                ...
                if (s.comboCharts) {
                    ...
                    case"area":
                        ...
                        break;
                    case"bar":
                        if (a.chart.stacked) b = new E(this.ctx, e).draw(s.series); else b = new T(this.ctx, e).draw(s.series);
                        break;
                    case"candlestick":
            ...
            key: "handleRangeDataFormat", value: function (t, e, i) {
                ...
                if ("array" === t) {
                    ...
                    for (var h = function (t) {
                        var r = e[i].data[t].x, o = {y1: e[i].data[t].y[0], y2: e[i].data[t].y[1]},
            ...
            key: "renderGrid", value: function () {
                ...
                if (!t.globals.isBarHorizontal || this.isTimelineBar) {
                    if (r = this.xaxisLabels.length, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                        ...
                        if (t.globals.timelineLabels.length || t.globals.invertedTimelineLabels.length) for (var u = 0; u < r; u++) {
                    ...
                    if (t.config.grid.yaxis.lines.show) {
                        var y = 0, w = 0, k = t.globals.gridWidth, A = o + 1;
                        ...
                        for (var S = 0; S < A; S++) {
                            ...
                            s.add(C), C.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(C, {
                                y1: y + 20,
                                y2: w + 20
                            }, {y1: y, y2: w}), w = y += t.globals.gridHeight / (this.isTimelineBar ? A : o)
                        }
                    }
                } else {
                    if (r = o, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) for (var L, P = t.globals.padHorizontal, z = t.globals.gridHeight, T = 0; T < r + 1 && (L = P = P + t.globals.gridWidth / r + .3, T !== r - 1); T++) {
                        if (t.config.grid.xaxis.lines.show) {
                    ...
                    if (t.config.grid.yaxis.lines.show) for (var M = 0, I = 0, X = t.globals.gridWidth, Y = 0; Y < t.globals.dataPoints + 1; Y++) {
                        ...
                        s.add(F), F.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(F, {
                            y1: M + 20,
                            y2: I + 20
                        }, {y1: M, y2: I}), I = M += t.globals.gridHeight / t.globals.dataPoints
                    }
                }
        ...
        return a(t, [{
            key: "drawSeriesTexts", value: function (t) {
                var e = t.shared, i = void 0 === e || e, a = t.ttItems, s = t.i, n = void 0 === s ? 0 : s, r = t.j,
                    o = void 0 === r ? null : r, l = t.y1, h = t.y2, c = this.w;
            ...
            key: "handleCustomTooltip", value: function (t) {
                var e = t.i, i = t.j, a = t.y1, s = t.y2, n = t.isArray, r = this.w, o = this.ttCtx.getElTooltip(),
