                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active active-menu">
                        ...
                        <ul id="userinfo" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle" style="">
                           ...
                           <li class="active"><a href="add-user.jsp"><i class="las la-plus-circle"></i>User Add</a></li>
                        ...
                        <form>
                           <div class="form-group">
                              <div class="add-img-user profile-img-edit">
                                 <img class="profile-pic img-fluid" src="${path}/resources/images/user/11.png" alt="profile-pic">
                                 <div class="p-image">
