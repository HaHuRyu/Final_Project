        ...
        <div class="row">
                                ...
                                <ul class="list-inline p-0 m-0 row justify-content-center search-menu-options">
                                        ...
                                        <div class="iq-dropdown">
                                            <div class="form-group mb-0">
                                                <select class="form-control form-search-control bg-white border-0"
                                                        id="exampleFormControlSelect1" name="field">
                                    ...
                                    <li class="search-menu-opt">
                                        <div class="iq-search-bar search-book d-flex align-items-center">
                                            <div class="searchbox">
                                                <input name="keyword" type="text" class="text search-input"
                                                       placeholder="키워드를 입력하세요">
                                            </div>
                                            <input type="submit" onclick="location.href='used_board_search.go'"
                                                   class="btn btn-primary search-data ml-2" value="검색"/>
                                        </div>
            ...
            <div align="right">
                <c:if test="${sessionScope.UserNo != null}">
                    <input align="right" type="button" onclick="location.href='seller_add.go'"
                           class="btn btn-primary search-data ml-2" value="글 등록"/>
                </c:if>
            </div>
            <br>
                                ...
                                <div class="iq-card iq-card-block iq-card-stretch iq-card-height search-bookcontent">
                                    <div class="iq-card-body p-0">
                                        <div class="d-flex align-items-center" <%--style="height: 186.51px;"--%>>
                                            <a href="book_page.go?seller_no=${dto.seller_no}"><img
