                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="admin-add-book.jsp" class="btn btn-primary">Add New book</a>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <div class="table-responsive">
                              <table class="data-tables table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/01.jpg" alt=""></td>
                                        ...
                                        <td>$89</td>
                                        <td><a href="book-pdf.jsp"><i class="ri-file-fill text-secondary font-size-18"></i></a></td>
                                        <td>
                                           <div class="flex align-items-center list-user-action">
                                             <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="admin-add-book.jsp"><i class="ri-pencil-line"></i></a>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/02.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/03.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/04.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/05.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/06.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/07.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/08.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/09.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td><img class="img-fluid rounded" src="${path}/resources/images/browse-books/10.jpg" alt=""></td>
