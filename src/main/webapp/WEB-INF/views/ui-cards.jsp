                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           <li class="elements active active-menu">
                              ...
                              <ul id="sub-menu" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 ...
                                 <li class="active"><a href="ui-cards.jsp"><i class="las la-credit-card"></i>Cards</a></li>
               ...
               <div class="row">
                  <div class="col-sm-3">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-mb-3">
                        <img src="${path}/resources/images/page-img/07.jpg" class="card-img-top" alt="#">
                        <div class="iq-card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height bg-dark text-white iq-mb-3">
                        <img src="${path}/resources/images/page-img/07.jpg" class="card-img" alt="#">
                  ...
                  <div class="col-lg-6">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-mb-3">
                        <div class="row no-gutters">
                           <div class="col-md-4">
                              <img src="${path}/resources/images/page-img/08.jpg" class="card-img" alt="#">
                           </div>
                           <div class="col-md-8">
                              <div class="iq-card-body">
                                 <h4 class="card-title">Card title</h4>
                  ...
                  <div class="col-lg-6">
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height iq-mb-3">
                        <div class="row no-gutters flex-row-reverse">
                           <div class="col-md-4">
                              <img src="${path}/resources/images/page-img/09.jpg" class="card-img" alt="#">
                           </div>
                           <div class="col-md-8">
