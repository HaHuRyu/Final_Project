                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="wizard-form" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 ...
                                 <li class="active"><a href="form-wizard-vertical.jsp"><i class="ri-anticlockwise-line"></i>Vertical Wizard</a></li>
                              </ul>
                           </li>
                           <li>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h5 class="mb-0">Vertical Wizard</h5>
                     <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="home.jsp">Home</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Vertical Wizard</li>
                        </ul>
                     </nav>
                  </div>
                              ...
                              <div class="col-md-9">
                                 <form id="form-wizard3" class="text-center">
                                    ...
                                    <fieldset>
                                       ...
                                       <a class="btn btn-primary action-button float-right" href="form-wizard-vertical.jsp" >Submit</a>
                                       <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-right mr-3" value="Previous" >Previous</button>
                                    </fieldset>
                                 </form>
                              </div>
