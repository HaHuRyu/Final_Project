...
<html lang="en">
   ...
   <body>
                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="charts" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 ...
                                 <li class="active"><a href="chart-high.jsp"><i class="ri-bar-chart-line"></i>High Charts</a></li>
      ...
      <script src="${path}/resources/js/highcharts-more.js"></script>
      <!-- Style Customizer -->
