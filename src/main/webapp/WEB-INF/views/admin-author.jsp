                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active active-menu">
                        ...
                        <ul id="admin" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="admin-author.jsp"><i class="ri-book-line"></i>Author</a></li>
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="admin-add-author.jsp" class="btn btn-primary">Add New Author</a>
                           </div>
                        </div>
                        <div class="iq-card-body">
                              ...
                              <table class="data-tables table table-striped table-bordered" style="width:100%">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>1</td>
                                       <td>
                                          <img src="${path}/resources/images/user/01.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Jhone Steben</td>
                                       <td>
                                    ...
                                    <tr>
                                       <td>2</td>
                                       <td>
                                          <img src="${path}/resources/images/user/02.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>John Klok</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>3</td>
                                       <td>
                                          <img src="${path}/resources/images/user/03.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Ichae Semos</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>4</td>
                                       <td>
                                          <img src="${path}/resources/images/user/04.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Jules Boutin</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>5</td>
                                       <td>
                                          <img src="${path}/resources/images/user/05.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Kusti Franti</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>6</td>
                                       <td>
                                          <img src="${path}/resources/images/user/06.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>David King</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>7</td>
                                       <td>
                                          <img src="${path}/resources/images/user/07.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Henry Jurk</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>8</td>
                                       <td>
                                          <img src="${path}/resources/images/user/08.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Attilio Marzi</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>9</td>
                                       <td>
                                          <img src="${path}/resources/images/user/09.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Argele Intili</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
                                    ...
                                    <tr>
                                       <td>10</td>
                                       <td>
                                          <img src="${path}/resources/images/user/10.jpg" class="img-fluid avatar-50 rounded" alt="author-profile">
                                       </td>
                                       <td>Attilio Marzi</td>
                                       <td>
                                          <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque. Etiam feugiat luctus est, vel commodo odio rhoncus sit amet</p>
