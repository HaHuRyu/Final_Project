                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="wizard-form" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 <li class="active"><a href="form-wizard.jsp"><i class="ri-clockwise-line"></i>Simple Wizard</a></li>
                              ...
                              <fieldset>
                                 <div class="form-card">
                                    ...
                                    <div class="row justify-content-center">
                                       <div class="col-3"> <img src="${path}/resources/images/page-img/img-success.png" class="fit-image" alt="fit-image"> </div>
                                    </div>
                                    <br><br>
                                    <div class="row justify-content-center">
