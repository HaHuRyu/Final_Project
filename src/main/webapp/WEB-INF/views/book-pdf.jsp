					...
					<ul id="iq-sidebar-toggle" class="iq-menu">
						<li class="active active-menu">
	                        ...
	                        <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
	                           ...
	                           <li class="active"><a href="book-pdf.jsp"><i class="ri-file-pdf-line"></i>Book Detail</a></li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="iq-card book-detail">
							<div class="iq-card-body p-0">
								<iframe src="${path}/resources/images/book/book.pdf"  style="width: 100%; height: 90vh;"></iframe>
							</div>
						</div>
					</div>
				</div>
