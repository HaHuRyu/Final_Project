                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="wizard-form" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 ...
                                 <li class="active"><a href="form-wizard-validate.jsp"><i class="ri-clockwise-2-line"></i>Validate Wizard</a></li>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h5 class="mb-0">Validate Wizard</h5>
                     <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="home.jsp">Home</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Validate Wizard</li>
                        </ul>
                     </nav>
                  </div>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="col-md-12 p-0">
                                       ...
                                       <div class="row justify-content-center">
                                          <div class="col-3"> <img src="${path}/resources/images/page-img/img-success.png" class="fit-image" alt="img-success"> </div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
