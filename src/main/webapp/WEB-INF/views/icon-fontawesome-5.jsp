                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="icons" class="iq-submenu collapse show" data-parent="#ui-elements">
                                 ...
                                 <li class="active"><a href="icon-fontawesome-5.jsp"><i class="ri-facebook-fill"></i>Font Awesome 5</a></li>
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h5 class="mb-0">Font Awesome 5</h5>
                     <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="home.jsp">Home</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Font Awesome 5</li>
                        </ul>
                     </nav>
                  </div>
