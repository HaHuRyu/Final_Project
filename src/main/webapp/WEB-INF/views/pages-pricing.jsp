                        ...
                        <ul id="pages" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active active-menu">
                              ...
                              <ul id="extra-pages" class="iq-submenu collapse show" data-parent="#pages">
                                 ...
                                 <li class="active"><a href="pages-pricing.jsp"><i class="ri-price-tag-line"></i>Pricing</a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="iq-card bg-dark text-white text-center iq-mb-3">
                        <img src="${path}/resources/images/page-img/25.jpg" class="card-img rounded" alt="#">
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="iq-card bg-dark text-white text-center iq-mb-3">
                        <img src="${path}/resources/images/page-img/26.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="iq-card bg-dark text-white text-center iq-mb-3">
                        <img src="${path}/resources/images/page-img/27.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-md-6 col-lg-3">
                     <div class="iq-card bg-dark text-white text-center iq-mb-3">
                        <img src="${path}/resources/images/page-img/28.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
